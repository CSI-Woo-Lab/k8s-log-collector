...
"""
suggested hypers
expectile=0.7, temperature=3.0 for all D4RL-Gym datasets
"""
...
def train(args=get_args()):
    ...
    if 'antmaze' in args.dataset:
        dataset["rewards"] -= 1.0
    if ("halfcheetah" in args.dataset or "walker2d" in args.dataset or "hopper" in args.dataset):
    ...
    args.workers = "none"
    x = k8s_logger("iql", args.batch_size, args.dataset, args.image_size, args.workers)
    ######### MINGEUN ###########
